  ...
  return (
    <>
      ...
      <aside className={`
        ...
        flex flex-col py-9 px-8 shadow-[4px_0_24px_rgba(0,0,0,0.15)]
      ...
      `}>
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 lg:hidden text-white/60 hover:text-white bg-white/10 rounded-full"
        >
        ...
        <div className="flex items-center gap-2.5 mt-4 lg:mt-0">
          ...
          />
          <span className="text-[18px] font-bold text-white tracking-tight">MyFarmer</span>
        </div>
        ...
        <div className="flex justify-center items-center my-6">
          {currentSlot ? (
            ...
            <div className="w-[160px] h-[160px] rounded-full bg-white/20 animate-pulse" />
          )}
        </div>
