...
class StoreRuleRekomendasiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'parameter.pakai_kriteria_total_alternatif' => ['required', 'boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'parameter.pakai_kriteria_total_alternatif.required' => 'Parameter pakai_kriteria_total_alternatif wajib diisi.',
