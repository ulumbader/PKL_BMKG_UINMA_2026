...
2. **Kriteria alternatif** (opsional): Hanya diperiksa jika `pakai_kriteria_total_alternatif` aktif dan kriteria utama gagal; total CH jendela harus ≥ `total_alternatif_mm`.
